    ...
    public partial class UIPullPaymentController : Controller
    {
        ...
        public async Task<IActionResult> ViewPullPayment(string pullPaymentId)
        {
            ...
            if (_pullPaymentHostedService.SupportsLNURL(blob))
            {
                ...
                var registerUrl = Url.Action(nameof(GreenfieldPullPaymentController.RegisterBoltcard), "GreenfieldPullPayment", new { pullPaymentId = vm.Id, command = "setup" }, Request.Scheme, Request.Host.ToString());
